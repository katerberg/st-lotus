...
export default function Decks() {
  ...
  const decks = [
    {number: 9, image: 'https://c1.scryfall.com/file/scryfall-cards/art_crop/front/2/f/2f8f22fb-7291-4517-9b15-e98501f2856b.jpg?1562702491', date: new Date('2022-08-13'), text: 'Mason Lange solidified his position as winningest drafter ever with his third victory on the back of powerful blue cards in a field that largely eschewed blue. There were many multi-colored decks that fought'},
    {number: 8, image: 'https://c1.scryfall.com/file/scryfall-cards/art_crop/front/c/2/c2089ec9-0665-448f-bfe9-d181de127814.jpg?1616182088', date: new Date('2022-03-26'), text: 'Mason Lange came back and tied the record of two VRD championships with a blue tempo deck (with some white), featuring flash creatures and many of the best cards ever printed. Managing to snag both Time Walk and'},
