...
function Home() {
  return (
    <div id="home">
      ...
      <p>{'[other schedule info]'}</p>
      <p>{'We stream our events on Twitch along with periodic draft recaps, set reviews, and other format-related discussions in between. '}<a href="https://www.twitch.tv/stlvrd">{'Follow us now so you don’t miss a stream!'}</a></p>
      ...
      <p><a href="https://www.twitter.com/stlvrd">{'Follow us on Twitter'}</a>{' to get updates about upcoming events, participate in giveaways, and be part of great discussions. If you want even more places to talk about Vintage Rotisserie Draft, why not '}<a href="https://discord.gg/nxBPYXn">{'join the VRD Discord right here'}</a>{' as well?'}</p>
