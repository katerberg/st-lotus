  ...
  return (
    <Container maxWidth="lg" >
      ...
      <RankedCard
        ...
        wins={15}
      />
      <Typography paragraph>Daretti, Scrap Savant is lowered somewhat because in many ways artifact strategies are easy to hate out. But as an extra Goblin Welder effect who can also dig for cards and fill the yard, I think Daretti is massively underutilized. Even Reanimator strategies should take a look at Daretti as they can pitch cards repeatedly with him and reuse cheap mana for a variety of artifact creatures.</Typography>
      <RankedCard
        availableDrafts={53}
        averageRound={14}
      ...
      <RankedCard
        ...
        wins={92}
      />
      <Typography paragraph>I moved the OG Tezz up and down my list several times. Tezz often finds a home as a tutor/enabler for Time Vault strategies, but I personally think Vault/Key has been overvalued in St. Lotus. Kyle in St. Lotus 7 put Tezzeret to strong use, fetching pieces for Lantern Combo, Grindstone Combo, and just untapping mana rocks. Like Daretti above, Tezz is hurt because artifact strategies are often a bit easier to hate out. So why does he stay in the top 10? One, he has great utility in a deck that is not solely based around artifacts but utilizes a few of them to great ability and two, he is a tutor and tutors are very strong.</Typography>
      <RankedCard
        availableDrafts={47}
        averageRound={11}
        ...
        wins={111}
      />
      <Typography paragraph>The greatest thief in the multiverse might have taken one for the team in WAR, but his power lives on in VRDs. Let’s be honest, I think most people draft Dack for the artifact stealing ability and think looting is purely upside. However, in a world of Hullbreacher and <Link href="https://scryfall.com/card/war/61/narset-parter-of-veils">Narset, Parter of Veils</Link>, the loot is a targetable effect and can be used offensively. In St. Lotus 6 I got nailed by my own Chains of Mephistopheles when Joe Wisdom targeted me with the + ability, and you might say it stole my will to live (I lost that game!). Though most ultimate abilities for VRD are not the main reason you draft the cards, Dack’s isn’t even worth considering. He probably should have stolen a better ability from someone else.</Typography>
      <RankedCard
        availableDrafts={56}
        averageRound={5}
        ...
        wins={129}
      />
      <Typography paragraph>Once the best walker in any format, Jace, the Mind Sculptor has fallen on hard times. Some folks in the discord have even argued that he is not a top 10 walker anymore. I obviously disagree, and I will take it a step further and argue that JTMS should be on the rise again. Why? Because if people start adapting to a format where dropping loyalty dice is one of the strongest thing you can do, Jace’s ability to protect other planeswalkers will be super powerful. Recently, his bounce only hitting creatures has in many ways lowered his utility, but if creatures continue on the come back they have of late? His stonks go up. One of the other things that lowers Jace somewhat is the fact that Brainstorming is not as good without a density of fetches to shuffle those bad cards away. The +2 fateseal is super powerful though. All together, for my buck, Jace is still a top 10 walker, but it is close.</Typography>
      <RankedCard
        availableDrafts={23}
        averageRound={29}
      ...
      <RankedCard
        ...
        wins={33}
      />
      <Typography paragraph>I happily grabbed the powerful Ashiok in St. Lotus 2 and rode them to several victories. The double dose of shutting off tutors (and fetches) as well as exiling cards from your opponent’s library/graveyard is potent. The Dream Render is particularly effective against decks that rely on 2/3 card combos. By sending 4 cards and the graveyard, you are likely to remove one key piece quickly. Many write Ashiok off as a sideboard card, but horned walker from an unknown world is pretty good in the main board due to their versatility at hating a lot of strategies that are popular in VRD.</Typography>
      <RankedCard
        availableDrafts={34}
        averageRound={18}
