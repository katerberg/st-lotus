...
export default function HowIWonMyVrd() {
  ...
  return (
    <Container maxWidth="lg" >
      ...
      <Typography paragraph>Beyond these, the automatic picks (like <Link href="https://scryfall.com/card/vma/9/mox-sapphire">Moxen</Link>, <Link href="https://scryfall.com/card/phed/67/sol-ring">Sol Ring</Link>, etc), and the generically good cards there are some early standouts I look for the opportunity to take:</Typography>
      <ComboCards cards={[{
        averageRound: 4,
        pickCount: 30,
        numberOfDrafts: 30,
      ...
      >
        ...
        <Typography >Taking this to its conclusion, <Link href="https://scryfall.com/card/mh1/244/prismatic-vista">Prismatic Vista</Link> is the most valuable fetchland of all - it has all those added benefits while being automatically on-color without needing to use another pick on a land.</Typography>
      </ComboCards>
      <ComboCards cards={[
        {
        averageRound: 5,
      ...
      >
        <Grid item
          ...
          xs={3}
        >
          <FullWidthImage src="/authors/dom-harvey.png"
