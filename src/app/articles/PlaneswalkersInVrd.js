  ...
  return (
    <Container maxWidth="lg" >
      ...
      <RankedCard
        ...
        wins={67}
      />
      <Typography paragraph>Another WAR walker, <Link href="https://scryfall.com/card/war/221/teferi-time-raveler">Teferi, Time Raveler</Link> comes down a lot quicker than <Link href="https://scryfall.com/card/wwk/31/jace-the-mind-sculptor">JTMS</Link> and has the added powerful static ability that shuts down your opponents instant speed spells. Outside of that, he gets to draw you some cards, bounce some permanents, and allow you to cast your sorceries as instant? What were they thinking? <Link href="https://scryfall.com/card/war/221/teferi-time-raveler">Tef3ri</Link> has some powerful two card combos himself that we’ve not seen played yet. If we mix him with cards like <Link href="https://scryfall.com/card/dgm/34/possibility-storm">Possibility Storm</Link> or <Link href="https://scryfall.com/card/mbs/111/knowledge-pool">Knowledge Pool</Link> we can lock our opponents out of the game entirely as they can only cast spells when they can cast a sorcery. Those locks may be too slow, but a strong control deck might be able to pull them off. Those types of silly fantasies aside, <Link href="https://scryfall.com/card/war/221/teferi-time-raveler">Teferi, Time Raveler</Link> is a powerful shutdown card that defends your own strategies and makes your opponent’s life miserable.</Typography>
      <RankedCard
        availableDrafts={19}
        averageRound={6}
        ...
        wins={49}
      />
      <Typography paragraph>Yep. Even in VRD, <Link href="https://scryfall.com/card/eld/197/oko-thief-of-crowns">Oko</Link> is Broko. The ability to shut down opponents artifacts and creatures repeatedly with a high loyalty is already worth its weight in gold, but since his release, we’ve also seen the shape shifting li’l minx go aggressive by turning unused artifacts such as <Link href="https://scryfall.com/card/5dn/143/pentad-prism">Pentad Prism</Link> into attackers. <Link href="https://scryfall.com/card/eld/197/oko-thief-of-crowns">Oko</Link>’s ultimate is one of the few that is relevant due to the ease of pulling it off. Switching out a Food token for a creature is powerful, even if we cap the creature at 3 power, there are a ton of useful creatures out there to trick onto your side of the battlefield. <Link href="https://scryfall.com/card/eld/197/oko-thief-of-crowns">Oko</Link> and <Link href="https://scryfall.com/card/war/221/teferi-time-raveler">Teferi</Link> are neck and neck at the 3-4 spot. In a different mood I could switch them easily, but for me <Link href="https://scryfall.com/card/eld/197/oko-thief-of-crowns">Oko</Link> takes the edge. It also helps that <Link href="https://scryfall.com/card/eld/197/oko-thief-of-crowns">Oko</Link> is in green which means it is easier to get him on turn 2.</Typography>
      <RankedCard
        availableDrafts={23}
        averageRound={5}
        ...
        wins={74}
      />
      <Typography paragraph>Taken 23 for 23 since her debut, I grabbed <Link href="https://scryfall.com/card/war/61/narset-parter-of-veils">Narset</Link> with pick 16 in the 2nd round. My original strategy for <Link href="https://scryfall.com/card/war/61/narset-parter-of-veils">Narset</Link> involved tutoring up <Link href="https://scryfall.com/card/vis/156/teferis-puzzle-box">Teferi’s Puzzle Box</Link> and locking people out of the game. Now when mixed with <Link href="https://scryfall.com/card/cmr/74/hullbreacher">Hullbreacher</Link> and <Link href="https://scryfall.com/card/cn2/77/leovold-emissary-of-trest">Leovold, Emissary of Trest</Link>, these types of wheel-based strategies are popular. Even without the combo shenanigans though, the <Link href="https://scryfall.com/card/war/61/narset-parter-of-veils">Veil Parter</Link> still shines. Digging deeper into your deck while shutting down extra card draw is a powerful combination and there is little doubt she is one of the most powerful VRD cards.</Typography>
      <RankedCard
        availableDrafts={23}
        averageRound={6}
        ...
        wins={79}
      />
      <Typography paragraph>While <Link href="https://scryfall.com/card/war/61/narset-parter-of-veils">Narset</Link> has gone higher generally (not by much), I think that is because of VRD players’ love for blue. For my money, the best walker in the format is <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn, the Great Creator</Link>. I think the strongest thing about <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Creator Karn</Link> is that he makes you draft better. What do I mean by that? Well, it is easy in VRD to draft too many main deck cards and not think about sideboards enough. Unless you are a super disciplined drafter like our own Elaine Cao, it is an easy trap to fall into. <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link> makes you focus on sideboard cards for your powerful <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link> board and gives you access to them.</Typography>
      <Typography paragraph>Beyond his <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link>-smorgasbord shenanigans, he is a built in one sided <Link href="https://scryfall.com/card/wth/154/null-rod">Null Rod</Link>. Having drafted him 2 of my 3 drafts and watched him in 2 others, I have seen many a game where shutting down mana rocks and artifact lands is enough to get there. Beyond those moments his utility is underestimated. He can animate equipment to make it fall off creatures (sorry germ, the <Link href="https://scryfall.com/card/mh2/227/kaldra-compleat">Kaldra</Link> is gone) and while they get a 7/7 for the turn, that is easily chump blocked. He can turn your own artifacts into blockers or attackers. He kills artifact lands and moxen (they can’t use them while he is out, but it is relevant if they kill him). </Typography>
      <Typography paragraph>The big target for the <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link>-board is of course <Link href="https://scryfall.com/card/dst/130/mycosynth-lattice">Mycosynth Lattice</Link>. I have won so many games with this combo I am surprised that more people are not hate drafting the <Link href="https://scryfall.com/card/dst/130/mycosynth-lattice">Lattice</Link> yet. I am normally of the mindset that hate-drafting is bad… but with <Link href="https://scryfall.com/card/dst/130/mycosynth-lattice">Lattice</Link>/<Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link>? I might waver on that. Other relevant targets are graveyard hate, <Link href="https://scryfall.com/card/mir/299/cursed-totem">Cursed Totem</Link>, <Link href="https://scryfall.com/card/ulg/125/defense-grid">Defense Grid</Link>, and <Link href="https://scryfall.com/card/sth/133/ensnaring-bridge">Ensnaring Bridge</Link>. Don’t forget, if your opponent exiles your artifacts with an exile effect, <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn</Link> can also get those back! Mix all that with the fact he is colorless and can go with any deck? <Link href="https://scryfall.com/card/war/1/karn-the-great-creator">Karn, the Great Creator</Link> is a good reason to pick <Link href="https://scryfall.com/card/lea/269/sol-ring">Sol Ring</Link> or <Link href="https://scryfall.com/card/phpr/5/mana-crypt">Mana Crypt</Link> round 1, as you can increase the chance of a second turn cast.</Typography>
      <SubSectionHeader
        component="h2"
        variant="h3"
